...
class Mosa_Forms {
	...
	private function load_dependencies() {
        ...
        /**
         * The class responsible for defining all fields and acf stuff that occur in the admin area
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mosa-forms-fields.php';
	...
	private function define_admin_hooks() {
        ...
        $plugin_fields = new Mosa_Forms_Fields( $this->get_plugin_name(), $this->get_version() );
        if(MOSA_FORMS_ACF) {
            $this->loader->add_filter( 'acf/settings/url', $plugin_fields, 'get_acf_url' );
            $this->loader->add_filter( 'acf/settings/show_admin', $plugin_fields, 'hide_acf_adminarea' );
        }

        $this->loader->add_filter( 'acf/init', $plugin_fields, 'register_acf_fields' );
	}
